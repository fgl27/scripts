...
if [ "$input1" == "1" ]; then
	...
	git fetch https://github.com/bhb27/Resurrection_packages_apps_Settings/ oreo && git cherry-pick c4782c842bb30eca97af9372ee8957b892a4f51e^..7c909f25c3e0a70874c50ae7ded5832d18121b71
	cd - &> /dev/null || exit;
