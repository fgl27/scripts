...
if [ "$input1" == "1" ]; then
	...
	git fetch https://github.com/bhb27/android_frameworks_base/ oreo && git cherry-pick 80f4c1e698989d29af045209444eb948f8ed1719^..b163c091e3073c22800d6bacf70d40220bffc407
	cd - &> /dev/null || exit;
