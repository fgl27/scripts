...
if [ "$input1" == "1" ]; then
	...
	git fetch https://github.com/bhb27/Resurrection_packages_apps_Settings/ oreo && git cherry-pick c4782c842bb30eca97af9372ee8957b892a4f51e^..1af5b435568b5965b82543672ff17f58887ad634
	cd - &> /dev/null || exit;
