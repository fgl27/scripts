...
if [ "$input1" == "1" ]; then
	...
	git fetch https://github.com/fgl27/android_frameworks_base/ oreo && git cherry-pick 80f4c1e698989d29af045209444eb948f8ed1719^..43908f68d1a2a6fee6322de89dd4cc7507a63d20
	cd - &> /dev/null || exit;
