...
if [ "$input1" == "1" ]; then
	...
	git fetch https://github.com/fgl27/android_frameworks_base/ oreo && git cherry-pick 80f4c1e698989d29af045209444eb948f8ed1719^..bbc8709f73aca27773a9015e62a938da68f7cb71
	cd - &> /dev/null || exit;
