...
jsonfie="$mainfolder""/quark_lineage_q.json"
...
url="https:\\/\\/downloads.sourceforge.net\\/project\\/fgl27\\/Android\\/Los\\/Q\\/""$filename"
...
# To send the file
scp $zip_path fgl27@frs.sourceforge.net:/home/frs/project/fgl27/Android/Los/Q/
